...
export const metadata = {
  title: "Activities | Gulmarg Apex Ski School",
  description:
    "Gondola rides, ATV rides, snowbiking, and bonfire evenings in Gulmarg.",
};
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20">
      <div className="max-w-2xl mb-14">
        ...
        <p className="text-slate-600 leading-relaxed">
          Beyond skiing and snowboarding, Gulmarg has a full menu of adventure
          &mdash; pick your thrill.
        </p>
      </div>
